...
\end{center}
%
\footnotetext[1]{Response to RFI NOT-GM-15-122: {\em Science Drivers Requiring Capable Exascale High Performance Computing}}
\footnotetext[2]{Stony Brook University}
\footnotetext[3]{Los Alamos National Laboratory}
\footnotetext[4]{Arizona State University}
\footnotetext[5]{michael.zingale@stonybrook.edu}
